# The Twelve-Factor App (12factor.net) — bundle offline

Title: The Twelve-Factor App

URL Source: https://12factor.net/codebase
...
![Image 1: One codebase maps to many deploys](https://12factor.net/images/codebase-deploys.png)
...
URL Source: https://12factor.net/dependencies
...
URL Source: https://12factor.net/config
...
URL Source: https://12factor.net/backing-services
...
![Image 1: A production deploy attached to four backing services.](https://12factor.net/images/attached-resources.png)
...
URL Source: https://12factor.net/build-release-run
...
![Image 1: Code becomes a build, which is combined with config to create a release.](https://12factor.net/images/release.png)
...
URL Source: https://12factor.net/processes
...
URL Source: https://12factor.net/port-binding
...
URL Source: https://12factor.net/concurrency
...
![Image 1: Scale is expressed as running processes, workload diversity is expressed as process types.](https://12factor.net/images/process-types.png)
...
URL Source: https://12factor.net/disposability
...
URL Source: https://12factor.net/dev-prod-parity
...
URL Source: https://12factor.net/logs
...
URL Source: https://12factor.net/admin-processes
