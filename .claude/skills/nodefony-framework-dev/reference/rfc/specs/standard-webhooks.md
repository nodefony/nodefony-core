...
| Secret serialization | base64 encoded, prefixed with \`whsec\_\` for easy identification. | base64 encoded, prefixed with \`whsk*\` for the secret key, and \`whpk*\` for the public key for easy identification. |
