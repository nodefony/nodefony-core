...
> **Ne couvre PAS** les recettes copier-coller (→ `reference/recipes-http.md`) ni les gotchas
> transverses (→ `reference/gotchas.md`). Ici = **surface exportée + mécanique interne + gotchas propres à http**.
