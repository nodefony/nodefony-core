...
> Recettes d'usage (écrire un service/module/CLI/config/ALS/erreurs) → `reference/recipes-core.md`.
> Gotchas transverses (hot path, RFC, idempotence…) → `reference/gotchas.md`. Ici = ce que ces deux-là ne disent pas.
>
...
> (Distincts des gotchas transverses de `reference/gotchas.md` et des recettes de `reference/recipes-core.md`.)
