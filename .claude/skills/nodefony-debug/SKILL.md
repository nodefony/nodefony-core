...
- **CLAUDE.md racine** : règle absolue perf+mémoire — le gate et ses seuils (table `THRESHOLDS` de `tests/helpers/retention.ts`) sont des blockers ; lecture d'un rouge → skill `nodefony-check-memory-health`.
