# Banc de découvrabilité — leçons et études de cas

> Détail du `SKILL.md` § « Banc de découvrabilité » : chaque leçon ci-dessous vient d'un défaut
> réellement trouvé — une sonde qui recalait un agent ayant fait juste, un juge qui accusait le
> mauvais coupable, un vert obtenu par abandon plutôt que par le travail demandé. Le corps du
> skill garde sous les yeux les commandes et le protocole de dépistage (1 run sur tout, 3 runs
...
- [Les sondes s'éprouvent AVANT de juger](#les-sondes-séprouvent-avant-de-juger)
- [Mesurer la PERFORMANCE sans jamais comparer une durée](#mesurer-la-performance-sans-jamais-comparer-une-durée)
- [Le meilleur juge demande à l'application, pas au dépôt](#le-meilleur-juge-demande-à-lapplication-pas-au-dépôt)
- [Un vert par ABANDON n'est pas un vert](#un-vert-par-abandon-nest-pas-un-vert)
- [Une tâche ne juge pas l'agent sur la saleté de la précédente](#une-tâche-ne-juge-pas-lagent-sur-la-saleté-de-la-précédente)
- [Le décor, ici aussi, est celui de l'utilisateur](#le-décor-ici-aussi-est-celui-de-lutilisateur)
- [Ce banc ne découvre pas les trous — il les garde fermés](#ce-banc-ne-découvre-pas-les-trous--il-les-garde-fermés)
