Title: Vite — guide-backend-integration

URL Source: https://vite.dev/guide/backend/integration

Version Vite installée dans ce dépôt au moment du figeage : 8.2.1 (doc = branche main du dépôt vitejs/vite).
