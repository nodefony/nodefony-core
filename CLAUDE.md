...
| **`nodefony-ticket`** | **Écrire, corriger ou trier des issues GitHub** — titre compréhensible sans connaître le dépôt, lexique des abréviations, parents/sous-tickets, champs du tableau de bord. À charger AVANT d'ouvrir ou de reformuler un ticket : un titre écrit sans lui se fait réécrire ensuite. Porte aussi **QUAND prendre un ticket** — l'ordre du tableau de bord dit les dépendances, pas le moment ; un ticket dont le contexte est déjà chargé coûte trois fois moins cher maintenant que dans deux semaines. |
