...
> Empreinte prise le **2026-09-24 18:49** (UTC).
...
| --- | --- | ---: | ---: | --- |
| **10.0.0-alpha** | ![10.0.0-alpha](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/6?style=flat-square&label=) `██████████` 96% | 153 | 6 | 2026-09-24 |
...
**#476 — feat(orm): donner ses propres migrations à un connecteur secondaire**

Ordre 4.7 · P2 — décision · 2 j · jalon 10.0.0-alpha · frise —
