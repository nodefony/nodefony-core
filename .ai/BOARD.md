...
> Empreinte prise le **2026-09-12 00:16** (UTC).
...
| --- | --- | ---: | ---: | --- |
| **10.0.0-alpha** | ![10.0.0-alpha](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/6?style=flat-square&label=) `████████░░` 83% | 74 | 15 | 2026-09-19 |
...
| 9.9405 | P0 — bloque le reste | 3.5 | 2026-11-19 → 11-19 | #340 | feat(cli): guider l'agent au-delà de la génération |
