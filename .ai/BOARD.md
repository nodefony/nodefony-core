...
> Empreinte prise le **2026-09-04 17:11** (UTC).
...
| 6 | P1 — figé à la création | 2.5 | #189 | feat(cli): refaire l'aide de nodefony pour l'humain et pour l'agent |
| 6.1 | P1 — figé à la création | 0.5 | #190 | fix(cli): rendre l'aide même hors d'une application |
| 6.2 | P1 — figé à la création | 1 | #191 | feat(cli): grouper l'aide par intention, avec un rendu pur et testable |
