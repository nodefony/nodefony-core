...
> Empreinte prise le **2026-09-21 19:15** (UTC).
...
| --- | --- | ---: | ---: | --- |
| **10.0.0-alpha** | ![10.0.0-alpha](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/6?style=flat-square&label=) `██████████` 96% | 139 | 6 | 2026-09-19 |
...
| 4.12 | P1 — figé à la création | 1 | — | #456 | fix(orm): ne pas ouvrir de base SQLite quand l'infra déclarée n'est pas SQL |
| 4.13 | P2 — décision | 1 | — | #457 | fix(studio): réparer les trois manquements d'accessibilité du tableau de bord ORM |
