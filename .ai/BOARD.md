...
> Empreinte prise le **2026-09-09 00:52** (UTC).
...
| --- | --- | ---: | ---: | --- |
| **10.0.0-alpha** | ![10.0.0-alpha](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/6?style=flat-square&label=) `██████░░░░` 61% | 23 | 15 | 2026-09-19 |
...
| Ordre | Prio | Jours | Ticket | Titre |
| --- | --- | ---: | --- | --- |
| 5 | P0 — bloque le reste | 1 | #288 | feat(config): rendre la config d'un module sûre et découvrable |
