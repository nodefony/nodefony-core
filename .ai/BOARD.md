...
> Empreinte prise le **2026-09-10 14:25** (UTC).
...
| --- | --- | ---: | ---: | --- |
| **10.0.0-alpha** | ![10.0.0-alpha](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/6?style=flat-square&label=) `███████░░░` 72% | 50 | 19 | 2026-09-19 |
...
| Ordre | Prio | Jours | Ticket | Titre |
| --- | --- | ---: | --- | --- |
| 9.91 | P1 — figé à la création | 9.5 | #316 | feat(scaffold): rendre l'application générée déployable en production |
