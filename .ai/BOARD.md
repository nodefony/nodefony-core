...
> Empreinte prise le **2026-09-24 19:14** (UTC).
...
| --- | --- | ---: | ---: | --- |
| **10.0.0-alpha** | ![10.0.0-alpha](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/6?style=flat-square&label=) `██████████` 97% | 154 | 5 | 2026-09-24 |
...
**#479 — ci: empêcher un process détaché de figer les jobs Windows après leur succès**

Ordre 4.9 · P1 — figé à la création · 0.5 j · jalon 10.0.0-alpha · frise —
