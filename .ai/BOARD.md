...
> Empreinte prise le **2026-09-26 00:56** (UTC).
...
| **10.0.0-beta** | ![10.0.0-beta](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/7?style=flat-square&label=) `████░░░░░░` 44% | 36 | 46 | 2026-10-10 |
...
Ordre 0.5 · P0 — bloque le reste · 1 j · jalon 10.0.0-beta · frise —
...
| --- | --- | ---: | --- | --- | --- |
| 0.5 | P0 — bloque le reste | 1 | — | #481 | feat(core): rendre atteignable le scope de requête par copie prototypale |
