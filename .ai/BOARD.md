...
> Empreinte prise le **2026-09-11 22:38** (UTC).
...
| --- | --- | ---: | ---: | --- |
| **10.0.0-alpha** | ![10.0.0-alpha](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/6?style=flat-square&label=) `█████████░` 85% | 74 | 13 | 2026-09-19 |
| **10.0.0-beta** | ![10.0.0-beta](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/7?style=flat-square&label=) `█░░░░░░░░░` 11% | 4 | 33 | 2026-10-14 |
...
| 9.9405 | P0 — bloque le reste | 2.5 | 2026-11-19 → 11-19 | #340 | feat(cli): guider l'agent au-delà de la génération |
