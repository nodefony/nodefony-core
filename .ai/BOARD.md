...
> Empreinte prise le **2026-08-31 21:15** (UTC).
...
| 2.6 | P2 — décision | 0.5 | #136 | feat(client): trancher ce qui vaut sans noyau, et l'éprouver sur les vitrines |
...
| 11.7 | P1 — figé à la création | 1 | #90 | test(devkit): auditer le module généré comme l'application générée |
