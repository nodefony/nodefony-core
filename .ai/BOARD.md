...
> Empreinte prise le **2026-09-09 05:53** (UTC).
...
| --- | --- | ---: | ---: | --- |
| **10.0.0-alpha** | ![10.0.0-alpha](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/6?style=flat-square&label=) `██████░░░░` 55% | 23 | 19 | 2026-09-19 |
...
| 16 | P1 — figé à la création | 1.5 | #289 | refactor(config): trancher où vit la config d'une application |
| 16.2 | P2 — décision | 1 | #285 | refactor(config): extraire la config par module dans nodefony/config |
| 16.5 | P2 — décision | 0.5 | #296 | feat(scaffold): montrer l'emplacement d'extraction de la config aux apps générées |
