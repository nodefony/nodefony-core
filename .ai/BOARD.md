...
> Empreinte prise le **2026-09-11 18:17** (UTC).
...
| --- | --- | ---: | ---: | --- |
| **10.0.0-alpha** | ![10.0.0-alpha](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/6?style=flat-square&label=) `████████░░` 80% | 69 | 17 | 2026-09-19 |
...
| 9.93 | P1 — figé à la création | 1 | — | #360 | feat(user): refuser les mots de passe manifestement faibles |
