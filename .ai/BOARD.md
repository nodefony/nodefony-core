...
> Empreinte prise le **2026-09-07 18:26** (UTC).
...
| --- | --- | ---: | ---: | --- |
| **10.0.0-alpha** | ![10.0.0-alpha](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/6?style=flat-square&label=) `█████░░░░░` 50% | 11 | 11 | 2026-09-19 |
...
| 1.4 | P1 — figé à la création | 0.5 | #274 | fix(gate): le contrôle de langue ne voit pas les identifiants des gabarits |
