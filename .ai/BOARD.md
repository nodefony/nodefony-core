...
> Empreinte prise le **2026-09-11 21:43** (UTC).
...
| --- | --- | ---: | ---: | --- |
| **10.0.0-alpha** | ![10.0.0-alpha](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/6?style=flat-square&label=) `████████░░` 84% | 73 | 14 | 2026-09-19 |
| **10.0.0-beta** | ![10.0.0-beta](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/7?style=flat-square&label=) `█░░░░░░░░░` 8% | 3 | 34 | 2026-10-14 |
...
| 45.3 | P1 — figé à la création | 1.5 | 2026-11-23 → 11-23 | #342 | docs(cli): dire à l'agent quelles briques l'application n'a PAS |
...
| 9.92 | P1 — figé à la création | 0.5 | — | #361 | docs(cli): retirer d'AGENTS.md ce qu'un skill livré porte déjà |
