...
> Empreinte prise le **2026-09-11 12:37** (UTC).
...
| 9.8 | P2 — décision | 0.5 | #352 | fix(http): empêcher un frontal de retenir un flux d'événements |
...
| 45 | P0 — bloque le reste | 9 | #340 | feat(cli): guider l'agent au-delà de la génération |
