...
> Empreinte prise le **2026-09-25 16:04** (UTC).
...
| **10.0.0-beta** | ![10.0.0-beta](https://img.shields.io/github/milestones/progress-percent/nodefony/nodefony-core/7?style=flat-square&label=) `████░░░░░░` 40% | 32 | 49 | 2026-10-10 |
...
| 0.95 | P1 — figé à la création | 1 | — | #490 | test(http): resserrer les seuils mémoire sur le bruit mesuré |
...
| 1.07 | P1 — figé à la création | 1 | — | #491 | fix(core): empêcher une requête de modifier la configuration partagée |
