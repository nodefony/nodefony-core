...
| --- | --- |
| `NF__DEBUG` | `src/nodefony/src/kernel/Kernel.ts:2898` |
...
| `NF_BOOT_TIMEOUT_MS` | `src/nodefony/src/kernel/Kernel.ts:3160` |
| `NF_BOOT_WARN_MS` | `src/nodefony/src/kernel/Kernel.ts:3172` |
...
| `NF_DEV_CHILD` | `src/nodefony/src/kernel/Kernel.ts:1008` |
...
| `NF_KERNEL_TRACE_FILE` | `src/nodefony/src/kernel/Kernel.ts:730` |
...
| `NF_START` | `src/nodefony/src/kernel/Kernel.ts:596` |
