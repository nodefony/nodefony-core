...
| --- | --- |
| `NF__DEBUG` | `src/nodefony/src/kernel/Kernel.ts:2706` |
...
| `NF_BOOT_TIMEOUT_MS` | `src/nodefony/src/kernel/Kernel.ts:2956` |
| `NF_BOOT_WARN_MS` | `src/nodefony/src/kernel/Kernel.ts:2968` |
...
| `NF_DEV_CHILD` | `src/nodefony/src/kernel/Kernel.ts:989` |
...
| `NF_KERNEL_TRACE_FILE` | `src/nodefony/src/kernel/Kernel.ts:711` |
...
| `NF_START` | `src/nodefony/src/kernel/Kernel.ts:589` |
