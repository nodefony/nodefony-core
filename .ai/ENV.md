...
| --- | --- |
| `NF__DEBUG` | `src/nodefony/src/kernel/Kernel.ts:2376` |
| `NF_BENCH_AUDIT_NOMINAL` | `src/packages/@nodefony/http/nodefony/service/http-kernel.ts:710` |
| `NF_BENCH_ROUTE` | `src/packages/@nodefony/framework/index.ts:461` |
| `NF_BOOT_TIMEOUT_MS` | `src/nodefony/src/kernel/Kernel.ts:2626` |
| `NF_BOOT_WARN_MS` | `src/nodefony/src/kernel/Kernel.ts:2638` |
...
| `NF_BROWSER_ACTIONS` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:88` |
| `NF_BROWSER_API` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/socket.mjs:60` |
| `NF_BROWSER_AXE` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:154` |
...
| `NF_BROWSER_EXPECT` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:53` |
| `NF_BROWSER_FAMILIES` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:109` |
| `NF_BROWSER_FORMFACTOR` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/audit.mjs:39` |
| `NF_BROWSER_FULLPAGE` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:822` |
...
| `NF_BROWSER_PROBES` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:134` |
| `NF_BROWSER_SEUIL_AUDIT` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/audit.mjs:38` |
| `NF_BROWSER_SEUIL_LENT` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:734` |
| `NF_BROWSER_SEUIL_LOURD` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:733` |
...
| `NF_BROWSER_WIDTHS` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:827` |
...
| `NF_DEV_CHILD` | `src/nodefony/src/kernel/Kernel.ts:851` |
...
| `NF_KERNEL_TRACE_FILE` | `src/nodefony/src/kernel/Kernel.ts:615` |
...
| `NF_NO_TTY` | `src/nodefony/src/kernel/Kernel.ts:487` |
...
| `NF_START` | `src/nodefony/src/kernel/Kernel.ts:506` |
