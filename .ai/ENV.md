...
| --- | --- |
| `NF__DEBUG` | `src/nodefony/src/kernel/Kernel.ts:2907` |
...
| `NF_DEV_CHILD` | `src/nodefony/src/kernel/Kernel.ts:1022` |
...
| `NF_KERNEL_TRACE_FILE` | `src/nodefony/src/kernel/Kernel.ts:744` |
...
| `NF_START` | `src/nodefony/src/kernel/Kernel.ts:607` |
