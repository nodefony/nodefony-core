...
| --- | --- |
| `NF__DEBUG` | `src/nodefony/src/kernel/Kernel.ts:2473` |
...
| `NF_BOOT_TIMEOUT_MS` | `src/nodefony/src/kernel/Kernel.ts:2723` |
| `NF_BOOT_WARN_MS` | `src/nodefony/src/kernel/Kernel.ts:2735` |
...
| `NF_BROWSER_FULLPAGE` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:823` |
...
| `NF_BROWSER_SEUIL_LENT` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:735` |
| `NF_BROWSER_SEUIL_LOURD` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:734` |
...
| `NF_BROWSER_WIDTHS` | `src/packages/@nodefony/devkit/skills/nodefony-browser/scripts/inspect.mjs:828` |
...
| `NF_KERNEL_TRACE_FILE` | `src/nodefony/src/kernel/Kernel.ts:691` |
...
| `NF_NO_TTY` | `src/nodefony/src/kernel/Kernel.ts:559` |
...
| `NF_START` | `src/nodefony/src/kernel/Kernel.ts:578` |
