 ...
 */
const FRENCH_WORDS = {
  // Verbes : infinitif, participe, 3ᵉ personne quand elle se lit dans du code.
  verbs: [
    "rendre",
    "rendu",
    "rendue",
  ...
  // Noms techniques : ce qu'on manipule dans un framework.
  nouns: [
    "fichier",
    "dossier",
    "repertoire",
  ...
  // Adjectifs, adverbes, mots-outils assez longs pour être discriminants.
  modifiers: [
    "utile",
    "inutile",
    "vrai",
...
export const EXCLUDED_HOMOGRAPHS = [
  ...
  "schema",
  "interface",
  // Mot anglais à part entière, sens différent — un anglophone l'écrirait seul.
  "cache",
  "charge",
  "pose",
  "retire",
  ...
  "etre",
  "organisation",
  // Mots-outils trop courts pour discriminer : ils sont des préfixes anglais
  // (`de` dans `deSerialize`, `non` dans `nonNull`) ou des abréviations.
  "de",
  "des",
  "du",
  "le",
 ...
 */
const ENGLISH_INFLECTIONS = new Set([
  "classes",
  "branches",
  "indices",
  "taxes",
 ...
 */
const FRENCH_IES_PLURALS = new Set([
  "sorties",
  "saisies",
  "reussies",
  "choisies",
