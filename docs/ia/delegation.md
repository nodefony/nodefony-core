...
**Comment confier une tâche à un agent sans détruire ni gaspiller.** Ces règles sont
**agnostiques du fournisseur** : aucun nom de modèle, aucun outil propriétaire. Elles
ont toutes été payées au moins une fois.

La carte du dépôt, les commandes et l'état vivent dans [`AGENTS.md`](../../AGENTS.md).
