...
> ℹ️ **6/6** contrôles normatifs (MUST) · 🛡️ **2/2** projet · 💡 **1/1** recommandé (SHOULD).
...
| Corps | 279 lignes |
| Coût d'activation | ~4 230 tokens (le corps est chargé à l'invocation) |
...
| corps < 500 lignes | recommandé | ✅ | 279 | best-practices : corps court (index) + détail en `references/` (divulgation progressive) |
