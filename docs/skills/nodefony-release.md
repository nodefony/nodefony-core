...
| Corps | 344 lignes |
| Coût d'activation | ~7 000 tokens (le corps est chargé à l'invocation) |
...
| corps < 500 lignes | recommandé | ✅ | 344 | best-practices : corps court (index) + détail en `references/` (divulgation progressive) |
