...
| Famille | Autres |
| Corps | 78 lignes |
| Coût d'activation | ~983 tokens (le corps est chargé à l'invocation) |
...
| corps < 500 lignes | recommandé | ✅ | 78 | best-practices : corps court (index) + détail en `references/` (divulgation progressive) |
