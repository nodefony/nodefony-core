...
> ℹ️ **6/6** contrôles normatifs (MUST) · 🛡️ **2/2** projet · 💡 **1/1** recommandé (SHOULD) · 🏷️ `v1.1.0`.
...
| corps < 500 lignes | recommandé | ✅ | 255 | best-practices : corps court (index) + détail en `references/` (divulgation progressive) |
