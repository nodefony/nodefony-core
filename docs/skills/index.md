...
**33 skills** · **33/33 conformes** au standard · régénérer : `node .claude/skills/nodefony-skill/scripts/skills-doc.mjs`
...
[
  ...
  { "icon": "🔧", "title": "ticket", "href": "nodefony-ticket.md",
    ...
    "meta": "🟢 conforme v1.8.0 · ⚙️ 17 scripts · 📎 7 réf" },
...
| [`nodefony-framework-dev`](nodefony-framework-dev.md) | 2.0.0 | 403 | 10 | 0 | ✅ |
...
| [`nodefony-session`](nodefony-session.md) | — | 206 | 3 | 11 | ✅ |
...
| [`nodefony-ticket`](nodefony-ticket.md) | 1.8.0 | 430 | 7 | 17 | ✅ |
...
| [`nodefony-dev`](nodefony-dev.md) | 1.2.0 | 481 | 0 | 1 | ✅ |
