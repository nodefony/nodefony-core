...
| `@nodefony/realtime`  | ✅   | **Durci** : back-pressure WS, 5 seams sécu, **204 tests verts** (+9 skipped docker ; inclut banc loopback isomorphe E2E L0 — VRAI client↔serveur) ; dettes backplane #1/#2 fixées (`c082560`). Reste dette #3 (frontière inter-modules, attend P6) + plan S1 (fan-out mutualisé, attend canal 100+ abonnés)                                                                                                                                                                                           |
...
━━━━━━ NODEFONY · MIGRATION ━━━━━━━━━━━━━━━━━━━ vérifié code 2026-06-12 ━━━━━━
 ...
 P6  Security              ███░░░░░░░  32%   5✅  2🔶 12⬜   ◀ bloqueur MVP — EN COURS (J1 authenticators · J2 argon2id+throttling · J3 ✅ session BFF, 127 unit + 19 intég)
