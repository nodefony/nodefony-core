...
| 🔶 P10.8  | Vues prio : dashboard, routes, sessions, users                              | 3 ses.  | P10.7              | 🔶 Dashboard ✅ **live** (CPU %/mémoire/event-loop/logs-s, graphes interactifs, uptime, debug, instance) ; **Modules ✅** (cartes + détail à onglets : Vue d'ensemble/**Docs**/**API**/Deps/Routes/Services/Config) ; routes/sessions/users en attente (data-plane IAdminApi) |
