...
>
> ✅ **P6 (ex-bloqueur MVP) = LEVÉ** : cœur sécurité livré (authn/authz/CSRF-CORS/API Keys/Audit/2FA/Webhooks/Sessions-Users/Firewall Studio). Reste = durcissement/niches **HORS MVP** (modèle session NIST, P6.18 audit persistant, mTLS/rpId, authz niveau B, OAuth resource-server, logs auth, live audit).
