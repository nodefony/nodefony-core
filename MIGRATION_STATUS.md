...
━━━━━━ NODEFONY · MIGRATION ━━━━━━━━━━━━━━━━━━━ vérifié code 2026-08-20 ━━━━━━
 ...
 P7  ORM drivers           ███████▏░░  72%   3✅  3🔶  1⬜   ◀ BLOQUEUR RELEASE — S1→S4 ✅ ; S5 DDL prod : 10 sous-tickets fermés sous #17 (génération, applicateur, commandes, sonde de disponibilité, app générée, écran de la console) ; **adoption d'une base sans historique ✅** (`949d5bcb` : `orm:migrate:baseline --from-database` + refus `NF_GENERATE_DATABASE_NOT_ADOPTED` ; impossible sur MariaDB — l'outil de lecture de schéma ne lit pas ses `CHECK (json_valid)` — et le refus le NOMME) ; reste #118 (preuve par le banc) + #99 (banc d'agent) + P7.11 NoSQL
