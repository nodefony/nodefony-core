...
| ✅ P0.4 | **BUG-001 + BUG-002** — propagation ALS (WS messages + `onAfterResponse`)   | Blocker P6 | 1 ses. | P1.4 ✅      | ✅ 2026-05-20 — `AsyncResource.bind` (WebsocketContext close/message + Context.onAfterResponse). 13 tests verts (10 ALS + 3 lifecycle), suite 475/0, memory OK. Cycle de vie validé : tear-down dedup intact, leaveScope/clean OK, 0 fuite listener → **avance P2.2 + P4.3**. **Débloque P6 décorateurs security isomorphes** |
