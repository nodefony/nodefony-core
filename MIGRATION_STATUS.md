...
| 🔶 P10.8  | Vues prio : dashboard, routes, sessions, users               | 3 ses.   | P10.7                        | 🔶 Dashboard ✅ **live** (CPU %/mémoire/event-loop/logs-s, graphes interactifs, uptime, debug, instance ; **jauge Heap V8 corrigée** = `heapUsed/heap_size_limit`, fini le 99% trompeur) ; **Modules ✅** ; **Routes ✅** (`RoutesView` TanStack via `/framework/api/routes`) ; sessions/users en attente (data-plane IAdminApi P5/P6)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
