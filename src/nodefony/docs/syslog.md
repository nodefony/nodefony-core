...
enregistre les cinq fabriques natives ; `Kernel.initializeLog()` (`Kernel.ts:2700`) résout le driver
...
et l'annonce par un `WARNING` (`Kernel.ts:3749`) — le principe « pas de dégradation silencieuse ».
