...
Ce dernier porte tout le cycle de vie du kernel via `Kernel.fireLifecycle()` (`Kernel.ts:2513`) : un
...
Côté kernel, `Kernel.fireLifecycle()` (`Kernel.ts:2513`) branche la politique : délai issu de
