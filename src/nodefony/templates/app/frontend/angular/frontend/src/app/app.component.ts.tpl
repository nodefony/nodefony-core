  ...
  template: `
    <div class="nf-split">
      ...
      <aside class="nf-hero">
        ...
        <div
          style="display:flex; gap:14px; align-items:center; position:relative"
        >
        ...
        <div style="max-width:480px; position:relative">
          ...
          <div class="nf-feature">
            <div class="nf-ficon">
              ...
              <svg viewBox="0 0 24 24">
                <path d="M13 2 4.5 12.5H11L9.5 22 18 11.5h-6.5L13 2z" />
              </svg>
            </div>
            <div>
              <div style="font-weight:600">Temps réel natif</div>
              <div class="nf-fdesc">
                HTTP et WebSocket, co-citoyens dans le même contexte.
              </div>
            </div>
          </div>
          <div class="nf-feature">
          ...
          <div class="nf-feature">
            <div class="nf-ficon">
              ...
              <svg viewBox="0 0 24 24">
                <path
                  d="M12 2 5 5v6c0 5 3.5 8.5 7 11 3.5-2.5 7-6 7-11V5l-7-3z"
                />
              </svg>
            </div>
            <div>
              ...
              <div class="nf-fdesc">
                Sécurité par défaut, vos données protégées.
              </div>
            </div>
          </div>
        </div>
      ...
      <main class="nf-main">
        <header class="nf-fwhead">
          ...
          <div>
            ...
            <span class="nf-fwbadge"
              >Angular v{{ ngVersion }} · Vite + AnalogJS</span
            >
          </div>
          <% if (it.complete) { %>
        ...
        <p class="nf-dim">
          ...
          <code>frontend/src/app/app.component.ts</code>, Vite recompile à la
          volée.
        </p>
        ...
        <div class="nf-card">
          ...
          <h2>
            1. Backend HTTP —
            <code
              >GET {{ secureData() ? "/api/secure/hello" : "/api/hello" }}</code
            >
          </h2>
          <% } else { %>
        ...
        <div class="nf-card">
          ...
          @if (data()?.who && data()?.who !== "anonyme") {
            <span style="margin-right:8px"
              >connecté — <strong>{{ data()?.who }}</strong></span
            >
            ...
            />
            <button (click)="doLogin(user.value, pass.value)">
              Se connecter
            </button>
          }
          @if (authMsg(); as m) {
        ...
        <div class="nf-card">
          ...
          <p>
            ...
            @if (tick(); as t) {
              <span>
                · tick <strong>#{{ t.n }}</strong> (pid {{ t.pid }})</span
              >
            }
          </p>
        ...
        <div class="nf-card">
          ...
          <p class="nf-dim">
            ...
            recompile à la volée. (Angular re-render le composant : l'état peut
            se réinitialiser.)
          </p>
        </div>
...
export class AppComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.#offLive.push(
      live.on("live:ticker", (msg) => this.tick.set(msg as Tick)),
    );
