...
const nodefonyBlue: MantineColorsTuple = [
  "#ebf3f9", "#c7def0", "#9ec5e5", "#73abd9", "#4792cd",
  "#217bc3", "#0067ba", "#00579c", "#00467e", "#003864",
];
const nodefonyGreen: MantineColorsTuple = [
  "#f0f5ef", "#d6e4d3", "#b8d0b3", "#98bb92", "#78a670",
  "#5c9452", "#448438", "#396f2f", "#2e5a26", "#25471e",
];
const nodefonyCyan: MantineColorsTuple = [
  "#ebf7fe", "#c7eafc", "#9edbfa", "#73cbf8", "#47bbf6",
  "#21acf4", "#00a0f2", "#0086cb", "#006da5", "#005683",
];
