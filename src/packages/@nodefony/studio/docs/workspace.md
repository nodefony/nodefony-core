...
Les deux filtres partagent **la même fonction** (`isVisibleForRoles()`, `roleNames.ts:82`) et les mêmes
paquets de rôles que la barre latérale (`VIEW_ROLES`, `roleNames.ts:98`) : c'est ce qui garantit qu'un
