...
server-http.ts (IncomingMessage) → http-kernel.ts.handle()
  ...
  → kernel "onRequestScope"            ← 1ᵉʳ point DANS la bulle ALS, avant parse : calque de config (ADR-0012) ; compté (0 écouteur = 0 coût)
