...
describe("@repository", () => {
  it("lie repo → entity via métadonnée (tag pur, pas de registre)", () => {
    @repository("repository.user", { entity: "User", orm: "sequelize" })
    class UserRepo {}
