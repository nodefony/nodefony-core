...
| ------------------ | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Controller`       | 514    | Extends Service. Props: `route`, `request`, `response`, `context`, `queryGet/Post/File`. `session` = **getter** sur `context.session` (pas de `startSession()` ; activation = `@UseSession`/`@Session`/cookie). API: `renderJson/renderView/renderFileDownload/renderMediaStream` (moteur Eta — pas de `renderTwig`/`renderEjs`), `redirect`, `forward`, `getSession`, `getFlashBag/setFlashBag`. **⚠ noms d'action réservés (conflit prop/méthode Controller) : `session`, `get`, `set`, `request`, `response`, `method`.**                                                                                                                                                                                                                            |
