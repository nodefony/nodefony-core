...
| `McpController`              | `nodefony/controllers/McpController.ts` | `POST /nodefony/mcp` — traduit HTTP ↔ JSON-RPC, ne calcule rien                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `handleMcpMessage`           | `nodefony/src/mcp/server.ts`            | protocole PUR : `server/discover`, `initialize`, `ping`, `tools/{list,call}` + validation de révision                                                                                                                                                                                                                                                                                                                                                                                         |
| `checkMcpAccess`             | `nodefony/src/mcp/guard.ts`             | garde PURE : `Origin` (absent = client natif → passe) + localité                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `listMcpTools`/`callMcpTool` | `nodefony/src/mcp/tools.ts`             | 4 outils (`inspect`, `check`, `symbols`, `card`), allowlist `Object.hasOwn`                                                                                                                                                                                                                                                                                                                                                                                                                   |
