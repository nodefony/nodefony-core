...
| Les canaux diffusables                 | `RealtimeBroadcast` (`realtimeDecorators.ts:342`), `RealtimeHub.markBroadcastChannel()` (`RealtimeHub.ts:365`)                                                                                                                                                                                                                       |
...
| Les politiques de canal                | `IChannelPolicy` (`IChannelPolicy.ts:20`), `RealtimeHub.registerChannelPolicy()` (`RealtimeHub.ts:734`), garde-fou `RealtimeHub.hasUnenforcedChannelPolicies()` (`RealtimeHub.ts:734`)                                                                                                                                               |
...
| Le plafond de canaux                   | `RealtimeHub.maxChannelsPerConnection` (`RealtimeHub.ts:227`)                                                                                                                                                                                                                                                                        |
| L'accueil et l'identité                | `IRealtimeWelcome` (`RealtimeEventMap.ts:204`)                                                                                                                                                                                                                                                                                       |
| La sonde                               | `RealtimeHub.probe()` (`RealtimeHub.ts:142`), `IRealtimeProbe` (`IRealtimeProbe.ts:61`), `IRealtimeChannelStat` (`IRealtimeProbe.ts:47`)                                                                                                                                                                                             |
