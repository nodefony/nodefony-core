...
| Ça marche à deux onglets, ça casse en cluster                          | Le canal n'est pas déclaré diffusable : par défaut, il reste **local au processus**.                                                             | Ajouter le préfixe dans `realtimeBroadcastChannels()` **et** choisir un driver de backplane.                                                                      |
...
| L'abonnement et son cycle de vie       | `RealtimeHub.subscribe()` (`RealtimeHub.ts:246`), `RealtimeController.startChannel()` (`RealtimeController.ts:618`)                                                                                                                                                                                                                  |
| La publication et le fan-out           | `RealtimeHub.publish()` (`RealtimeHub.ts:315`), réinjection locale `RealtimeHub.publishLocal()` (`RealtimeHub.ts:334`)                                                                                                                                                                                                               |
| Les canaux diffusables                 | `RealtimeController.realtimeBroadcastChannels()` (`RealtimeController.ts:195`), `RealtimeHub.markBroadcastChannel()` (`RealtimeHub.ts:365`)                                                                                                                                                                                          |
| Le branchement du backplane            | `RealtimeHub.setBackplane()` (`RealtimeHub.ts:395`), registre `registerBackplaneDriver()` (`backplaneRegistry.ts:55`), cloison `resolveBackplaneOriginId()` (`originId.ts:24`)                                                                                                                                                       |
| Les politiques de canal                | `IChannelPolicy` (`IChannelPolicy.ts:20`), `RealtimeHub.registerChannelPolicy()` (`RealtimeHub.ts:713`), garde-fou `RealtimeHub.hasUnenforcedChannelPolicies()` (`RealtimeHub.ts:696`)                                                                                                                                               |
...
| La révocation en cours de session      | `RealtimeHub.revalidateRevocable()` (`RealtimeHub.ts:464`)                                                                                                                                                                                                                                                                           |
| Le consommateur lent                   | seuil `SLOW_CONSUMER_BYTES` (`RealtimeHub.ts:56`), fermeture `slow consumer` (`WsConnectionTransport.ts:88`)                                                                                                                                                                                                                         |
| Le plafond de canaux                   | `RealtimeHub.maxChannelsPerConnection` (`RealtimeHub.ts:636`)                                                                                                                                                                                                                                                                        |
| L'accueil et l'identité                | `IRealtimeWelcome` (`RealtimeEventMap.ts:204`)                                                                                                                                                                                                                                                                                       |
| La sonde                               | `RealtimeHub.probe()` (`RealtimeHub.ts:503`), `IRealtimeProbe` (`IRealtimeProbe.ts:61`), `IRealtimeChannelStat` (`IRealtimeProbe.ts:47`)                                                                                                                                                                                             |
...
| Le service injectable                  | `RealtimeService.publish()` (`RealtimeService.ts:141`), `RealtimeService.probe()` (`RealtimeService.ts:179`), `RealtimeService.markBroadcastChannel()` (`RealtimeService.ts:188`)                                                                                                                                                    |
...
| Le client navigateur                   | `RealtimeClient.connect()` (`RealtimeClient.ts:311`), `RealtimeClient.subscribe()` (`RealtimeClient.ts:430`), `RealtimeClient.request()` (`RealtimeClient.ts:569`), `RealtimeClient.onDenied()` (`RealtimeClient.ts:386`)                                                                                                            |
| L'upload                               | `UploadedFile` (`routerDecorators.ts:1004`), `IUploadedFile` (`IUpload.ts:49`), `queryFile` (`Request.ts:109`)                                                                                                                                                                                                                       |
