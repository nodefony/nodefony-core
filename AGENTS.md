...
|                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Une application minimale générée** | **quatre dépendances déclarées** — `nodefony`, `@nodefony/http`, `@nodefony/framework`, `zod`. Se constate : `src/nodefony/templates/app/base/package.json.tpl`. C'est ce que l'application ÉCRIT ; l'arbre installé en compte une centaine, comme tout projet Node — ce qui se vérifie, et ce qui compte, c'est qu'aucun n'est un paquet maison doublant l'écosystème (serveurs `node:http`/`node:http2`, ORM Drizzle, front Vite, validation Zod) |
...
| **Publication npm**       | **préversion `10.0.0-alpha.8`**, les quinze paquets, sous le canal `alpha` SEULEMENT — `npm install nodefony` sert toujours `nodefony@7.0.2` (JavaScript). Les `@nodefony/*-bundle` de l'ère 7 sont dépréciés                                                                                                                              |
