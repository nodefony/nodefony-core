...
| **Publication npm**    | **préversion `10.0.0-alpha.6`**, les quinze paquets, sous le canal `alpha` SEULEMENT — `npm install nodefony` sert toujours `nodefony@7.0.2` (JavaScript). Les `@nodefony/*-bundle` de l'ère 7 sont dépréciés |
